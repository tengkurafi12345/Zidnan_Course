...
@section('content')
    <section class="form-container">
        ...
        <form action="{{ route('job.vacancy.store') }}" method="post" enctype="multipart/form-data">
            ...
            <p>Nama Lowongan</p>
            <input type="text" name="title" class="form-control box" value="{{ old('title') }}">

            <p>Lokasi</p>
            <input type="text" name="location" class="form-control box" value="{{ old('location') }}">
            ...
            <p>Tenggat Waktu</p>
            <input type="date" name="date_line" class="form-control box" value="{{ old('date_line') }}">

            <p>Deskripsi</p>
            <textarea name="job_description" placeholder="Masukkan Deskripsi" class="form-control box">{{ old('job_description') }}</textarea>
            ...
            <textarea name="responsibility_description" placeholder="Masukkan Deskripsi Tanggung Jawab" class="form-control box">{{ old('responsibility_description') }}</textarea>
            ...
            <textarea name="qualification_description" placeholder="Masukkan Deskripsi Kualifikasi" class="form-control box">{{ old('qualification_description') }}</textarea>
