...
@section('title', 'Daftar Kelas Program')
        ...
        <div class="table-responsive">
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tbody>
                    @forelse($program_classes as $programClass)
                        <tr>
                            <td>{{ $loop->iteration }}</td>
                            <td>
                                @if($programClass->logo)
                                    <img src="{{ asset('storage/' . $programClass->logo) }}"
                                         alt="Logo {{ $programClass->name }}"
                                         style="max-width: 80px; max-height: 80px; border-radius: 5px; object-fit: cover;">
                                @else
                                    <span class="text-muted">No Logo</span>
                                @endif
                            </td>
                            <td>{{ $programClass->name }}</td>
                            <td>{{ $programClass->caption }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="10" class="text-center">No Program Class available.</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
